...
<!-- ```{r} -->
<!-- bad_trait <- filter(all_traits,abs(pve_ind-pve_rssp)/pve_ind==max(abs(pve_ind-pve_rssp)/pve_ind)) %>% pull(trait) -->
<!-- good_trait <- filter(all_traits,abs(pve_ind-pve_rssp)/pve_ind==min(abs(pve_ind-pve_rssp)/pve_ind)) %>% pull(trait) -->
<!-- ``` -->
