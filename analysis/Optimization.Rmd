---
title: "Optimizing in MATLAB vs R"
output: html_notebook
---

# Background

In this notebook we'll explore differences between Xiang's and Nick's `RSSp` implementations

## The data

The data consists of 100 simulations and paired results from Xiang's RSSp-0 `MATLAB` code.  Each simulation consists of  10000 draws of `vhat` from $N(0,16)$, and  10000 draws of `dvec` from $\text{Unif}(0,1)$ 
